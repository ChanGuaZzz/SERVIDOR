...
<body class=" align-items-center d-flex bg-dark">
    ...
    if (isset($_SESSION["usuario"]) || isset($_POST["usuario"], $_POST["clave"]) && Consultas::ComprobarInicio($_POST["usuario"], $_POST["clave"])) {
            ...
            <div class="row  ">
                <div class="col-lg-2  col-md-2 col-xl-2 acciones col-sm-12 ">
                    <form action="../consultas/añadir.php" method="post">
                        <input class="inputs" type="text" name="cancion" placeholder="cancion" required>
                        <input class="inputs" type="text" name="autor" placeholder="autor" required>
                        <input class="inputs" type="text" name="genero" placeholder="genero" required>
                        <br>
                        <br>
                    ...
                    <form action="../consultas/update.php" method="post">
                        <input class="inputs idmod" name="id" style="background-color: darkslategrey; color: yellow;" readonly type="text" name="id" placeholder="id de la cancion">
                        <input class="inputs nmod" type="text" name="cancion" placeholder="Cancion" required>
                        <input class="inputs amod" type="text" name="autor" placeholder="Autor" required>
                        <input class="inputs gmod" type="text" name="genero" placeholder="Genero" required>
                        <br>
                        <br>
